...
| 2 | Repeated utility use | Completed human utility uses, from a reproducible bot-filtered event | `>= 100` | Trailing 30 days | Begin Level 2 monetization work against demonstrated human use |
